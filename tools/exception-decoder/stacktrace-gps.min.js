!(function(e, n) {
  ...
  function t(e) {
    if (e instanceof Object)
      for (var r = o.concat(i.concat(s.concat(a))), t = 0; t < r.length; t++)
  ...
  for (var l = 0; l < s.length; l++)
    (t.prototype['get' + n(s[l])] = r(s[l])),
      (t.prototype['set' + n(s[l])] = (function(e) {
        return function(n) {
          this[e] = String(n);
        };
      })(s[l]));
...
var SourceMap = (function(e) {
  ...
  function(e, n, r) {
    ...
    (t.fromSourceMap = function(e) {
      ...
      (o.prototype._parseMappings = function(e, n) {
        for (
          ...
          if (';' === e.charAt(v)) c++, v++, (p = 0);
            ...
            if (((t = e.slice(v, s)), (o = y[t]))) v += t.length;
              ...
              for (o = []; v < s; )
                l.decode(e, v, C), (u = C.value), (v = C.rest), o.push(u);
              if (2 === o.length)
        ...
        g(b, a.compareByGeneratedPositionsDeflated),
          (this.__generatedMappings = b),
          g(w, a.compareByOriginalPositions),
      ...
      (s.prototype._parseMappings = function(e, n) {
        ...
        for (var r = 0; r < this._sections.length; r++)
          for (
            ...
            var c = t.consumer._names.at(s.name);
  ...
  function(e, n) {
    ...
    function i(e) {
      ...
      for (
        var s, a = n.isAbsolute(r), u = r.split(/\/+/), c = 0, l = u.length - 1;
        l >= 0;
        l--
      )
        (s = u[l]),
  ...
  function(e, n, r) {
    ...
    (n.encode = function(e) {
      var n,
        r = '',
        o = t(e);
      do (n = o & u), (o >>>= s), o > 0 && (n |= c), (r += i.encode(n));
      while (o > 0);
      return r;
    }),
    ...
    function o(e, n, i, s) {
      if (i < s) {
        var a = t(i, s),
          u = i - 1;
        r(e, a, s);
        for (var c = e[s], l = i; l < s; l++)
          n(e[l], c) <= 0 && ((u += 1), r(e, u, l));
        r(e, u + 1, l);
        var g = u + 1;
...
!(function(e, n) {
  'use strict';
  'function' == typeof define && define.amd
    ? define('stacktrace-gps', ['source-map', 'stackframe'], n)
    : 'object' == typeof exports
      ? (module.exports = n(
          require('source-map/lib/source-map-consumer'),
          require('stackframe')
        ))
      : (e.StackTraceGPS = n(e.SourceMap || e.sourceMap, e.StackFrame));
})(this, function(e, n) {
  'use strict';
  function r(e) {
  ...
  function c(e, r, t) {
    return new Promise(function(o, i) {
      ...
      if (s.source) {
        var a = r.sourceContentFor(s.source);
        a && (t[s.source] = a),
          o(
            new n({
  ...
  return function l(g) {
    return this instanceof l
      ? ((g = g || {}),
        (this.sourceCache = g.sourceCache || {}),
        (this.sourceMapConsumerCache = g.sourceMapConsumerCache || {}),
        (this.ajax = g.ajax || r),
        (this._atob = g.atob || t),
          ...
          return new Promise(
            function(t, i) {
              if (this.sourceMapConsumerCache[n])
                ...
                (this.sourceMapConsumerCache[n] = s), t(s);
              }
            }.bind(this)
          );
        }),
                  ...
                  function(r) {
                    ...
                    return (
                      '/' === i[0] ||
                        ...
                        /^https?:\/\/|^\/\//i.test(i) ||
                        (i = a + i),
                      this._getSourceMapConsumer(i, a).then(function(r) {
                        return c(e, r, t)
                          .then(n)
                          ['catch'](function() {
                            n(e);
