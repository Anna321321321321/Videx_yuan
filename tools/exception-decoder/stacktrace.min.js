            ...
            return {
              ...
              parseOpera9: function(n) {
                for (
                  ...
                  s &&
                    o.push(
                      new e({ fileName: s[2], lineNumber: s[1], source: t[i] })
                    );
                }
                return o;
              },
        ...
        function(e, n, r) {
          ...
          function o(e) {
            ...
            (t = t
              ...
              .map(s.normalize)
              .map(function(e) {
                return i && s.isAbsolute(i) && s.isAbsolute(e)
                  ? s.relative(i, e)
                  : e;
              })),
          ...
          (t.fromSourceMap = function(e) {
            ...
            (t.prototype.allGeneratedPositionsFor = function(e) {
              ...
              if (
                (null != this.sourceRoot &&
                  (r.source = s.relative(this.sourceRoot, r.source)),
            ...
            (o.prototype.sourceContentFor = function(e, n) {
              ...
              if (
                (null != this.sourceRoot &&
                  (e = s.relative(this.sourceRoot, e)),
                this._sources.has(e))
              )
            ...
            (o.prototype.generatedPositionFor = function(e) {
              ...
              if (
                (null != this.sourceRoot &&
                  (n = s.relative(this.sourceRoot, n)),
                !this._sources.has(n))
              )
            ...
            (a.prototype.originalPositionFor = function(e) {
              ...
              return t
                ? t.consumer.originalPositionFor({
                    line:
                      n.generatedLine - (t.generatedOffset.generatedLine - 1),
                    column:
                      n.generatedColumn -
              ...
              for (var r = 0; r < this._sections.length; r++)
                for (
                  ...
                  null !== t.consumer.sourceRoot &&
                    (u = s.join(t.consumer.sourceRoot, u)),
                    this._sources.add(u),
                  ...
                  var l = {
                    source: u,
                    generatedLine:
                      a.generatedLine + (t.generatedOffset.generatedLine - 1),
                    generatedColumn:
                      a.generatedColumn +
      ...
      8: [
        function(e, n, r) {
          ...
          function s(e, n) {
            ...
            var r = o(n),
              t = o(e);
            if ((t && (e = t.path || '/'), r && !r.scheme))
              return t && (r.scheme = t.scheme), i(r);
            if (r || n.match(_)) return n;
            if (t && !t.host && !t.path) return (t.host = n), i(t);
            var s =
              '/' === n.charAt(0) ? n : a(e.replace(/\/+$/, '') + '/' + n);
          ...
          !(function(n, o) {
            ...
            function t(e) {
              if (e instanceof Object)
                for (
                  var r = o.concat(i.concat(a.concat(s))), t = 0;
                  t < r.length;
                  t++
                )
                  e.hasOwnProperty(r[t]) &&
                    void 0 !== e[r[t]] &&
                    this['set' + n(r[t])](e[r[t]]);
            }
        ...
        function(n, r, t) {
          !(function(o, i) {
            ...
            'function' == typeof e && e.amd
              ...
              : 'object' == typeof t
                ? (r.exports = i(
                    n('source-map/lib/source-map-consumer'),
                    n('stackframe')
                  ))
                : (o.StackTraceGPS = i(
                    o.SourceMap || o.sourceMap,
                    o.StackFrame
                  ));
          })(this, function(e, n) {
            'use strict';
                  ...
                  (t.onreadystatechange = function() {
                    4 === t.readyState &&
                      ...
                      ('file://' === e.substr(0, 7) && t.responseText)
                        ...
                        : r(
                            new Error(
                              'HTTP status: ' + t.status + ' retrieving ' + e
                            )
                          ));
                  }),
                  t.send();
                    ...
                    return new Promise(
                      function(t, i) {
                        if (this.sourceMapConsumerCache[n])
                          t(this.sourceMapConsumerCache[n]);
                        else {
                          var a = new Promise(
                            function(t, i) {
                            ...
                            function(r) {
                              ...
                              return (
                                '/' === i[0] ||
                                  ...
                                  /^https?:\/\/|^\/\//i.test(i) ||
                                  (i = s + i),
                                this._getSourceMapConsumer(i, s).then(function(
                                  r
                                ) {
                                  return c(e, r, t)
                                    .then(n)
          ...
          !(function(o, i) {
            ...
            return {
              ...
              generateArtificially: function(e) {
                ...
                var r = n.backtrace(e);
                return (
                  'function' == typeof e.filter && (r = r.filter(e.filter)),
                  Promise.resolve(r)
                );
              },
