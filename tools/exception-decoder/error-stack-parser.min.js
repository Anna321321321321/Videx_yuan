!(function(e, t) {
  ...
  function n(e) {
    if (e instanceof Object)
      for (var r = i.concat(a.concat(o.concat(s))), n = 0; n < r.length; n++)
        e.hasOwnProperty(r[n]) &&
          void 0 !== e[r[n]] &&
          this['set' + t(r[n])](e[r[n]]);
  }
  ...
  for (var c = 0; c < i.length; c++)
    (n.prototype['get' + t(i[c])] = r(i[c])),
      (n.prototype['set' + t(i[c])] = (function(e) {
        return function(t) {
          this[e] = Boolean(t);
        };
      })(i[c]));
  for (var u = 0; u < a.length; u++)
    (n.prototype['get' + t(a[u])] = r(a[u])),
  ...
  for (var f = 0; f < o.length; f++)
    (n.prototype['get' + t(o[f])] = r(o[f])),
      (n.prototype['set' + t(o[f])] = (function(e) {
        return function(t) {
          this[e] = String(t);
        };
      })(o[f]));
